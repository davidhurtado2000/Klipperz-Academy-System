...
if ($_SESSION["user"] == "" && $_SESSION["password-field"] == "") {
    ...
    $listaDatosFinanciero = $objFinanciero->ControllerMostrarGananciasGenerales($year);
    ...
    <body class="d-flex flex-column min-vh-100" style="background-color: transparent;">
        <div class="container-fluid" style="background-color: white;">
            ...
            <div class="row my-2">
                ...
                <div class="col-lg-2">
                    <form action="ReportesGanancias.php" method="post" id="yearform">
                        <select class="form-select" aria-label="Default select example" name="year" onchange="submitForm()">
