...
if ($_SESSION["user"] == "" && $_SESSION["password-field"] == "") {
    ...
    <body class="d-flex flex-column min-vh-100" style="background-color: transparent;">
        <div class="container-fluid py-2" style="background-color: white;">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" aria-current="page" href="RegistrarClase.php">Registrar
                                            Clases</a>
                                    </li>
                                    <li class="nav-item">
            ...
            <form action="../controller/ControllerAlumnos.php" method="post">
                ...
                <?php foreach ($listarClasesEspecifica as $filaDatos) { ?>
                    ...
                    <div class="form-group border-bottom border-dark">
                        ...
                        <img src="../img/imgRegistroAlumno/info.png" alt="Responsive image" id="imgRegis" class="my-2"><input
                            type="date" class="form-control border-0" id="fch_nacimiento" name="fch_nacimiento"
                    ...
                    <div class="form-group border-bottom border-dark">
                        ...
                        <select class="form-select" aria-label="Default select example">
                            <option value="<?php echo $filaDatos["idturno"]; ?>" selected><?php echo $filaDatos["nombret"]; ?></option>
                            <?php foreach ($listarTurnos as $fileTurno) { ?>
                            <option value="<?php echo $fileTurno["idturno"]; ?>"><?php echo $fileTurno["nombret"]; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group border-bottom border-dark">
                        ...
                        <img src="../img/imgRegistroAlumno/info.png" alt="Responsive image" id="imgRegis">
                        <select class="form-select" aria-label="Default select example">
                            <option value="<?php echo $filaDatos["idnivel"]; ?>" selected><?php echo $filaDatos["nomnivel"]; ?></option>
                            <?php foreach ($listarNivel as $fileNivel) { ?>
                            <option value="<?php echo $fileNivel["idnivel"]; ?>"><?php echo $fileNivel["nomnivel"]; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group border-bottom border-dark">
                        ...
                        <br>
                        <label>
                            <input type="radio" name="uniformerpta" value="1"> Si
                        </label>
                        <label>
                            <input type="radio" name="uniformerpta" value="0"> No
                        </label>
                    </div>
                    ...
                    <div class="form-group border-bottom border-dark">
                        ...
                        <br>
                        <label>
                            <input type="radio" name="estadorpta" value="1"> Si
                        </label>
                        <label>
                            <input type="radio" name="estadorpta" value="0"> No
                        </label>
                    </div>
                    ...
                    <div class="form-group border-bottom border-dark">
                        ...
                        <button class="btn btn-primary"
                            onclick="generateForm('<?php echo $filaDatos['nombret']; ?>', '<?php echo $idFormBoleta1; ?>')">Registrar/Actualizar</button>
                        <div id="formboleta1" class="mt-3"></div>
                    </div>
                    ...
                    <div class="form-group border-bottom border-dark">
                        ...
                        <img src="../img/imgRegistroAlumno/city.png" alt="Responsive image" id="imgRegis">
                        <button class="btn btn-primary"
                            onclick="generateForm('<?php echo $filaDatos['nombret']; ?>', '<?php echo $idFormBoleta2; ?>')">Registrar/Actualizar</button>
                        <div id="formboleta2" class="mt-3"></div>
                    </div>
                    ...
                    <div class="form-group border-bottom border-dark">
                        ...
                        <img src="../img/imgRegistroAlumno/city.png" alt="Responsive image" id="imgRegis">
                        <button class="btn btn-primary"
                            onclick="generateForm('<?php echo $filaDatos['nombret']; ?>', '<?php echo $idFormBoleta3; ?>')">Registrar/Actualizar</button>
                        <div id="formboleta3" class="mt-3"></div>
                    </div>

                    <div class="form-group border-bottom border-dark">
                        <label for="nombres">Nota</label>
                        <img src="../img/imgRegistroAlumno/info.png" alt="Responsive image" id="imgRegis"><input type="text"
                            ...
                            value="<?php echo $filaDatos["nota"]; ?>" required>
                    </div>
